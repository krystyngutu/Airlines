...
with col1:
    ...
    fig_mon = px.bar(
        ...
        labels={'month_name': 'Month', 'price': 'Avg Price (USD)'},
        text_auto=True
    )
...
with col2:
    ...
    fig_sea = px.bar(
        sea_df,
        x='season', y='price',
        labels={'season': 'Season', 'price': 'Avg Price (USD)'},
        text_auto=True
    )
...
with col3:
    ...
    fig_dow = px.bar(
        dow_df,
        x='weekday', y='price',
        labels={'weekday': 'Day', 'price': 'Avg Price (USD)'},
        text_auto=True
    )
...
with col4:
    ...
    fig_tod = px.bar(
        tod_df,
        x='timeOfDay', y='price',
        labels={'timeOfDay': 'Time of Day', 'price': 'Avg Price (USD)'},
        text_auto=True
    )
...
with col5:
    ...
    fig_lay = px.bar(
        ...
        labels={'numLayovers': '# of Layovers', 'price': 'Avg Price (USD)'},
        text_auto=True
    )
